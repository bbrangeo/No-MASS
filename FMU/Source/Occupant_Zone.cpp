...
void Occupant_Zone::setupWindows(int agentid, const ConfigStructAgent &agent,
  ...
  if ((agent.WindowOpenDuringCooking > 0 ||
    ...
    std::cerr << "Occupant_Zone:: setupWindows Config 1 "  << std::endl;
    ...
    std::cerr << "Occupant_Zone:: setupWindows Config 2 "  << std::endl;
    ...
    std::cerr << "Occupant_Zone:: setupWindows Config 3 "  << std::endl;
